...
def process_song_file(cur, filepath):
    ...
    # transform song into artist data
    artist_data = df[[
        'artist_id',
        'artist_name',
        'artist_location',
...
def process_log_file(cur, filepath):
    ...
    # transform song and log datasets into songplay data    
